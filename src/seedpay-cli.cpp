...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Seedpay Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  Seedpay-cli [options] <command> [params]  " + _("Send command to Seedpay Core") + "\n" +
                        "  Seedpay-cli [options] help                " + _("List commands") + "\n" +
                        "  Seedpay-cli [options] help <command>      " + _("Get help for a command") + "\n";
