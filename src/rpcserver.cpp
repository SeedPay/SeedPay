...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Seedpay server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Seedpay features */
        {"Seedpay", "masternode", &masternode, true, true, false},
        {"Seedpay", "listmasternodes", &listmasternodes, true, true, false},
        {"Seedpay", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Seedpay", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Seedpay", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Seedpay", "masternodedebug", &masternodedebug, true, true, false},
        {"Seedpay", "startmasternode", &startmasternode, true, true, false},
        {"Seedpay", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Seedpay", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Seedpay", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Seedpay", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Seedpay", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Seedpay", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Seedpay", "mnbudget", &mnbudget, true, true, false},
        {"Seedpay", "preparebudget", &preparebudget, true, true, false},
        {"Seedpay", "submitbudget", &submitbudget, true, true, false},
        {"Seedpay", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Seedpay", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Seedpay", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Seedpay", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Seedpay", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Seedpay", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Seedpay", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Seedpay", "checkbudgets", &checkbudgets, true, true, false},
        {"Seedpay", "mnsync", &mnsync, true, true, false},
        {"Seedpay", "spork", &spork, true, true, false},
        {"Seedpay", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"Seedpay", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Seedpayd, or the -server option to Seedpay-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Seedpay-cli " + methodname + " " + args + "\n";
}
