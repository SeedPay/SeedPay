...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Seedpay Core Seedpay-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Seedpay-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Seedpay transaction") + "\n" +
                               "  Seedpay-tx [options] -create [commands]   " + _("Create hex-encoded Seedpay transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Seedpay transaction
