...
/** Utility functions used by the Seedpay Qt UI.
 */
namespace GUIUtil
{
...
// Render Seedpay addresses in monospace font
...
// Parse "Seedpay:" URI into recipient object, return true on successful parsing
