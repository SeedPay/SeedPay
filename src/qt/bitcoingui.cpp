                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Seedpay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Seedpay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Seedpay: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Seedpay Core"), this);
    aboutAction->setStatusTip(tr("Show information about Seedpay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Seedpay"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Seedpay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Seedpay addresses"));
    ...
    openAction->setStatusTip(tr("Open a Seedpay: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Seedpay Core help message to get a list with possible Seedpay command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Seedpay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Seedpay network", "", count));
}
...
{
    QString strTitle = tr("Seedpay Core"); // default title
