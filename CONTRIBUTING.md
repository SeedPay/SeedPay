Contributing to Seedpay Core
============================

The Seedpay Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Seedpay Core project, and is not to be
confused with overall Seedpay Network Protocol consensus changes.

Whether a pull request is merged into Seedpay Core rests with the project merge
...
Patches that change Seedpay consensus rules are considerably more involved than
...
Where a patch set proposes to change the Seedpay consensus, it must have been
...
The project leader is the release manager for each Seedpay Core release.
