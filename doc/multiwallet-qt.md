...
In order to support loading of multiple wallets in Seedpay-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Seedpay.cpp.
...
Changes to Seedpay.cpp
----------------------
Seedpay.cpp is the entry point into Seedpay-qt, and as such, will require some minor modifications to provide hooks for
