...
This mechanism has been integrated into Bitcore-Node-Seedpay which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Seedpay-Project/insight-api-Seedpay#web-socket-api](https://github.com/Seedpay-Project/insight-api-Seedpay#web-socket-api) 
* API: [https://github.com/Seedpay-Project/insight-api-Seedpay#swifttx-transactions](https://github.com/Seedpay-Project/insight-api-Seedpay#swifttx-transactions) 
...
By default, the Seedpay Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Seedpay Core daemon:
